...
#ifndef PROJECT_TESTS_SERVICE_MODULE_STRESS_TEST_FUNC_H_
#define PROJECT_TESTS_SERVICE_MODULE_STRESS_TEST_FUNC_H_
...
#endif  // PROJECT_TESTS_SERVICE_MODULE_STRESS_TEST_FUNC_H_
