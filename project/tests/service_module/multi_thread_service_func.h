...
#ifndef PROJECT_TESTS_SERVICE_MODULE_MULTI_THREAD_SERVICE_FUNC_H_
#define PROJECT_TESTS_SERVICE_MODULE_MULTI_THREAD_SERVICE_FUNC_H_
...
#endif  // PROJECT_TESTS_SERVICE_MODULE_MULTI_THREAD_SERVICE_FUNC_H_
